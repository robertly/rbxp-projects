...
function BeamBetween.new(attachment0: Attachment, attachment1: Attachment, beamPrefab: Beam): ClassType
	local self = {
...
function BeamBetween._setup(self: ClassType, originalAttachment0: Attachment, originalAttachment1: Attachment)
