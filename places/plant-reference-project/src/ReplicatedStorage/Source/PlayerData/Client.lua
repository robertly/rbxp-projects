...
function PlayerDataClient._listenForEvents()
	Network.connectEvent(
		Network.RemoteEvents.PlayerDataLoaded,
		...
		t.tuple(t.keys(t.string), t.boolean, t.optional(t.string))
	)

	Network.connectEvent(Network.RemoteEvents.PlayerDataUpdated, function(valueName: string, value: any)
		PlayerDataClient._onDataUpdated(valueName, value)
	end, t.tuple(t.string, t.optional(t.any)))

	Network.connectEvent(
		Network.RemoteEvents.PlayerDataSaved,
		function(success: boolean, errorType: PlayerDataErrorType.EnumType?)
			PlayerDataClient._onDataSaved(success, errorType)
		end,
		t.tuple(t.boolean, t.optional(t.string))
	)
end
